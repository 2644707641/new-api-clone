...
export const Grainient: React.FC<GrainientProps> = ({
  ...
  centerY = 0.0,
  zoom = 0.9,
  color1 = '#0284C7', // Muted Deep Cyan
  color2 = '#6D28D9', // Deep Cosmic Purple
  color3 = '#070913', // Atmospheric Dark Base
  className = '',
}) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Fallback for browsers with WebGL context creation issues
      return
    }
